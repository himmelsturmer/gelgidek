    ...
    <section class="section">
      <div class="container" style="max-width:800px;">
        ...
        <div class="info-card" style="border-left:4px solid var(--accent);">
          <h3>⚠️ Dikkat</h3>
          <ul class="doc-list">
            <li>Vize başvurularını olabildiğince erken yapmanız (en az 1 ay öncesinden) tavsiye edilir.</li>
            <li>Çalışma ve öğrenim amaçlı vizeler ülkeye göre 2-3 ay veya daha uzun sürebilir.</li>
            <li>Pasaportunuzun başvuru tarihinden itibaren en az 1 yıl geçerli olmasına özen gösterin.</li>
            <li>Vizeden muaf olsanız bile gideceğiniz ülkenin pasaport geçerlilik koşullarını öğrenin.</li>
          </ul>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="faq-list">
          <details class="faq-item">
            <summary>Schengen Ülkeleri hangileridir?</summary>
            <p>Almanya, Fransa, İtalya, İspanya, Hollanda, Belçika, Polonya, Avusturya, Portekiz, İsveç, Danimarka, Finlandiya, Norveç, İsviçre, Çek Cumhuriyeti, Macaristan, Slovakya, Slovenya, Yunanistan, Estonya, Letonya, Litvanya, Lüksemburg, Malta, İzlanda ve Lihtenştayn Schengen üyesidir.</p>
          </details>
          <details class="faq-item">
            <summary>Vize nedir?</summary>
            <p>Vize; bir ülkeye giriş izni veren, pasaport üzerine yapıştırılan veya elektronik ortamda düzenlenen resmi bir belgedir. Her ülke kendi vize politikasına göre farklı koşullar belirlemektedir.</p>
          </details>
          <details class="faq-item">
            <summary>Vize başvurularında dikkat edilecek hususlar nelerdir?</summary>
            <p>Gerekli belgeleri eksiksiz hazırlayın, biometrik fotoğraf standartlarına uyun, pasaportunuzun geçerlilik süresini kontrol edin, seyahat sigortasını erken yaptırın ve randevunuzu zamanında alın.</p>
          </details>
          <details class="faq-item">
            <summary>E-Pasaport nedir?</summary>
            <p>E-Pasaport, içinde çipli bir kimlik doğrulama mekanizması bulunan biyometrik pasaporttur. Sahibine ait biyometrik veriler (yüz, parmak izi) bu çip üzerinde saklanır.</p>
          </details>
          <details class="faq-item">
            <summary>Schengen vizesi nerelerde kullanılır?</summary>
            <p>Schengen vizesi, Schengen Bölgesi'ni oluşturan tüm üye ülkelerde geçerlidir. Tek bir Schengen vizesiyle tüm üye ülkeleri ziyaret edebilirsiniz.</p>
          </details>
        </div>
      </div>
    </section>
